      ...
      <section className="body__section py-10">
        <div className="grid place-items-center mt-5">
          <p className="text-3xl font-bold text-center text-white uppercase mb-2">
            HOW AgroVision HELPS
          </p>
          <p className="text-xl font-medium text-center text-white ">
            Being a part of AgroVision, these are our mainstays
          </p>
        </div>
        <div className="grid place-items-center mt-14 mb-20">
          <div className="inline-flex space-x-36 items-center justify-end">
            <div className="w-1/4 h-full">
              <div className="inline-flex flex-col space-y-6 items-center justify-end flex-1 h-full pl-9 pr-8 pt-8 pb-11 bg-black border rounded border-black border-opacity-10">
                <img className="w-1/5 h-12 rounded-lg" src={Help} alt="help" style={{filter: 'invert(1)'}} />
                <p className="w-56 h-7 text-lg font-semibold text-white text-center">
                  24*7 calls and help desk
                </p>
                <p className="opacity-70 w-56 h-1/5 text-base text-white text-center">
            ...
            <div className="w-1/4 h-full">
              <div className="inline-flex flex-col space-y-6 items-center justify-end flex-1 h-full pl-9 pr-8 pt-8 pb-11 bg-black border rounded border-black border-opacity-10">
                <img className="w-14 h-14 rounded-lg" src={SMS} alt="SMS" style={{filter: 'invert(1)'}} />
                <p className="w-56 h-7 text-lg font-semibold text-white text-center">
